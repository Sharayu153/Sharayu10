      ...
      clear: both;
        ...
        <div class="top-background">
            <div class="menu" id="sticky">
                ...
                <ul class="menu-ul">
                    <li><img src="image/D1.jpeg" alt="SCP"></li>
        ...
        <div class="page-blocks">
          <div class="title" data-aos="fade-right">
             <b>ABOUT US</b>
              ...
              DECORAL Design transforms houses into homes. We give a complete look to your home also create customized furniture, window treatments, soft goods, cabinetry/casework design, color schemes and finishes. We also partner with many talented artisans that help bring our design concepts to life.
  </br>
              DECORAL Design carefully layers textures and finishes with custom color and specific pieces to create personalized, inviting and livable spaces. No design project is the same. </br>Putting the individual needs of each homeowner, their distinct tastes, budget and timeline as a top priority, every design will focus on how spaces will actually be used.
              
  </br> When needed, DECORAL Design goes beyond the design studio and collaborates with a team of vendors, artists, contractors and speciality artisans to ensure the success of every project.
           </div>
    ...
    <div class="social-media-icons">
        ...
        <div class="box">
          <h2> EMAIL US</h2>
                    ...
                    <label>InteriorDecor@gmail.com</label>
                    <i class=" fa fa-phone"></i>
                    <label>+ 91 8888880000 </label>
                  </div>
                </div>

</div>
</div>
<div class="copyrights"><i class="fa fa-copyright" aria-hidden="true"></i>2023 Copyright, All Rights Reserved</div>
